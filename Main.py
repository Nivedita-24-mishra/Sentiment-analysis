...
def setResult(type, res):
    if (type == "neg"):
        negativeLabel.configure(text = "Negative Output : " + '%.2f' % res + "  \n")
    if (type == "neu"):
        neutralLabel.configure( text = "Neutral Output : " + '%.2f' % res + "  \n")
    if (type == "pos"):
        positiveLabel.configure(text = "Positive Output : " + '%.2f' % res + "  \n")

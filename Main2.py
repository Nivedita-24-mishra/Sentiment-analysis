...
class analysis_text():
    ...
    def setResult(self, type, res):
        if (type == "neg"):
            self.negativeLabel.configure(text = "Negative word : " + str(res) + " % \n")
        if (type == "neu"):
            self.neutralLabel.configure( text = "Neutral word  : " + str(res) + " % \n")
        if (type == "pos"):
            self.positiveLabel.configure(text = "Positive word  : " + str(res) + " % \n")
    ...
    def __init__(self):
        ...
        self.label1 = Label(text = "Input Text:")
        self.label1.pack()
